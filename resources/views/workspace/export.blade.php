            ...
            <x-ui.card>
                ...
                <x-ui.card-content class="space-y-4">
                    ...
                    <div class="pt-4 border-t text-sm text-muted-foreground">
                        ...
                        <p>Name, Email, Phone, Phone Country, City, Birthday, Gender, Company, Job Title, Website, Address, Status, Rating, Lifecycle Stage, Notes, Comment, Facebook, Twitter, LinkedIn, Category, Tags, Custom Fields, Owner, Created At, Last Contacted</p>
                    </div>
                </x-ui.card-content>
            </x-ui.card>
        </div>
