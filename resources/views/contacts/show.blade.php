                                    ...
                                    <x-ui.card-content class="p-4">
                                        <div class="flex items-start justify-between gap-3 mb-2">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                @endphp
                                                @if ($canEditNote)
                                                    <button @click="editing_{{ $note->id }} = !editing_{{ $note->id }}" class="inline-flex items-center gap-1 px-2 py-1 text-xs text-muted-foreground hover:text-foreground hover:bg-accent rounded transition-colors" title="Edit note">
