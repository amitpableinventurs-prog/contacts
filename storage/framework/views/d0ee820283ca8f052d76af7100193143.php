...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        <div class="space-y-2 text-center">
            <?php $brand = app(\App\Settings\GeneralSettings::class); ?>
            <?php if($brand->logo_path): ?>
                <img src="<?php echo e(asset('storage/'.$brand->logo_path)); ?>" alt="<?php echo e($brand->app_name); ?>" class="h-12 w-12 rounded-xl object-contain mx-auto" />
            <?php else: ?>
                <div class="mx-auto grid h-12 w-12 place-items-center rounded-xl bg-primary text-primary-foreground text-xl font-bold">
                    <?php echo e(mb_substr($brand->app_name, 0, 1)); ?>

                </div>
            <?php endif; ?>
            <h1 class="text-2xl font-semibold tracking-tight"><?php echo e($brand->app_name); ?></h1>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','type' => 'email','name' => 'email','value' => ''.e(old('email')).'','required' => true,'autofocus' => true,'autocomplete' => 'username','placeholder' => 'you@example.com']); ?>
...
<?php unset($__componentOriginalb2c43a998f3174877f99993c62e16bb4); ?>
<?php endif; ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-muted-foreground hover:text-foreground">Forgot password?</a>
                </div>
                <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','class' => 'w-full h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-full h-10']); ?>Sign in <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp_lite\xampp_lite_8_3\www\laracontact\resources\views/auth/login.blade.php ENDPATH**/ ?>