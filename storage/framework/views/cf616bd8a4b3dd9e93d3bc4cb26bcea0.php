...
<div x-data="{
    ...
    selected: 0,
    contacts: [],
    nav: <?php echo \Illuminate\Support\Js::from($nav->map(fn ($i) => ['label' => $i['label'], 'href' => route($i['route'])]))->toHtml() ?>,
    autocompleteUrl: '<?php echo e(route('contacts.autocomplete')); ?>',
    smsUrlFor: id => '<?php echo e(url('/sms')); ?>/' + id,
    contactUrlFor: id => '<?php echo e(url('/contacts')); ?>/' + id,
...
<?php /**PATH D:\xampp_lite\xampp_lite_8_3\www\laracontact\resources\views/components/app/command-palette.blade.php ENDPATH**/ ?>