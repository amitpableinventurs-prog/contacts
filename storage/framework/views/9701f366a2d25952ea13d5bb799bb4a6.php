...
<div class="flex h-14 items-center gap-2 px-4 border-b">
    ...
    <?php else: ?>
        <div class="grid place-items-center h-8 w-8 rounded-lg bg-primary text-primary-foreground font-bold"><?php echo e(mb_substr($brand->app_name, 0, 1)); ?></div>
    <?php endif; ?>
    <span class="font-semibold tracking-tight truncate"><?php echo e($brand->app_name); ?></span>
</div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('workspace.export'))]); ?>Export workspace data <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale61527cd5af239231438271d50ff42a5)): ?>
<?php $attributes = $__attributesOriginale61527cd5af239231438271d50ff42a5; ?>
<?php unset($__attributesOriginale61527cd5af239231438271d50ff42a5); ?>
...
<div class="px-4 py-2 border-b flex items-center gap-2">
    ...
    ?>
    <span class="inline-flex items-center rounded px-2 py-0.5 text-[10px] font-medium <?php echo e($roleColor); ?>"><?php echo e($roleLabel); ?></span>
    <span class="text-xs text-muted-foreground truncate"><?php echo e($user->name); ?></span>
</div>
